...
exports.getVisaApplicationForAmendment = async (req, res) => {
    try {
        ...
        const travelers = visaApplication.visa_application_fields.map(traveller => ({
            ...
            // File paths
            passport_size_photo: traveller.passport_size_photo ? process.env.BASE_URL + traveller.passport_size_photo : null,
            passport_front_photo: traveller.passport_front_photo ? process.env.BASE_URL + traveller.passport_front_photo : null,
            passport_back_photo: traveller.passport_back_photo ? process.env.BASE_URL + traveller.passport_back_photo : null,
            pan_card_photo: traveller.pan_card_photo ? process.env.BASE_URL + traveller.pan_card_photo : null,
            itr_1st_year_photo: traveller.itr_1st_year_photo ? process.env.BASE_URL + traveller.itr_1st_year_photo : null,
            itr_2nd_year_photo: traveller.itr_2nd_year_photo ? process.env.BASE_URL + traveller.itr_2nd_year_photo : null,
            itr_3rd_year_photo: traveller.itr_3rd_year_photo ? process.env.BASE_URL + traveller.itr_3rd_year_photo : null,
            vaccination_certificate: traveller.vaccination_certificate ? process.env.BASE_URL + traveller.vaccination_certificate : null,
            medical_insurance_certificate: traveller.medical_insurance_certificate ? process.env.BASE_URL + traveller.medical_insurance_certificate : null,
            employment_letter: traveller.employment_letter ? process.env.BASE_URL + traveller.employment_letter : null,
            proof_of_funds: traveller.proof_of_funds ? process.env.BASE_URL + traveller.proof_of_funds : null,
            flight_booking: traveller.flight_booking ? process.env.BASE_URL + traveller.flight_booking : null,
            travel_insurance: traveller.travel_insurance ? process.env.BASE_URL + traveller.travel_insurance : null,
            travel_itinerary: traveller.travel_itinerary ? process.env.BASE_URL + traveller.travel_itinerary : null,
            hotel_booking: traveller.hotel_booking ? process.env.BASE_URL + traveller.hotel_booking : null,
            invitation_letter: traveller.invitation_letter ? process.env.BASE_URL + traveller.invitation_letter : null,
            three_months_bank_statement: traveller.three_months_bank_statement ? process.env.BASE_URL + traveller.three_months_bank_statement : null,
            six_months_bank_statement: traveller.six_months_bank_statement ? process.env.BASE_URL + traveller.six_months_bank_statement : null,
            three_months_bank_signed_and_stamped_statement: traveller.three_months_bank_signed_and_stamped_statement ? process.env.BASE_URL + traveller.three_months_bank_signed_and_stamped_statement : null,
            six_months_bank_signed_and_stamped_statement: traveller.six_months_bank_signed_and_stamped_statement ? process.env.BASE_URL + traveller.six_months_bank_signed_and_stamped_statement : null,
            aadhar_card: traveller.aadhar_card ? process.env.BASE_URL + traveller.aadhar_card : null,
            passport_external_cover: traveller.passport_external_cover ? process.env.BASE_URL + traveller.passport_external_cover : null,
